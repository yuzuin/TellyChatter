	...
	<div id="wrapper">
		...
		<div id="main">
				...
				<header>
					...
					<div class="meta">
						...
						<a href="#" class="author"><span class="name">Jane Doe</span><img
							src="${pageContext.request.contextPath}/resources/assets/images/avatar.jpg" alt="" /></a>
					</div>
				</header>
				<a href="single.html" class="image featured"><img
					src="${pageContext.request.contextPath}/resources/assets/images/pic01.jpg" alt="" /></a>
			...
			<article class="post">
				...
				<a href="single.html" class="image featured"><img
					src="${pageContext.request.contextPath}/resources/assets/images/pic02.jpg" alt="" /></a>
				<p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus
					nisl. Sed mattis nunc id lorem euismod placerat. Vivamus porttitor
					magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies
			...
			<article class="post">
				...
				<a href="single.html" class="image featured"><img
					src="${pageContext.request.contextPath}/resources/assets/images/pic03.jpg" alt="" /></a>
				<p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus
					nisl. Sed mattis nunc id lorem euismod placerat. Vivamus porttitor
					magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies
					mi non congue ullam corper. Praesent tincidunt sed tellus ut
		...
		<section id="sidebar">
			...
			<!-- Intro -->
			<section id="intro">
				<a href="#" class="logo"><img src="${pageContext.request.contextPath}/resources/assets/images/logo.jpg" alt="" /></a>
				<header>
					<h2>Movie Chatter</h2>
					<p>
						영화나 드라마 시리즈에 대해 말해보아요~
					</p>
				</header>
			</section>
			...
			<section>
				<div class="mini-posts">
					...
					<article class="mini-post">
						<header>
							...
							<time class="published" datetime="2015-10-20">October 20,
								2015</time>
							<a href="#" class="author"><img src="${pageContext.request.contextPath}/resources/assets/images/avatar.jpg"
								alt="" /></a>
						</header>
						<a href="single.html" class="image"><img
							src="${pageContext.request.contextPath}/resources/assets/images/pic04.jpg" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img
							src="${pageContext.request.contextPath}/resources/assets/images/pic05.jpg" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img
							src="${pageContext.request.contextPath}/resources/assets/images/pic06.jpg" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img
							src="${pageContext.request.contextPath}/resources/assets/images/pic07.jpg" alt="" /></a>
					</article>
				...
				<ul class="posts">
					<li>
						<article>
							...
							<a href="single.html" class="image"><img
								src="${pageContext.request.contextPath}/resources/assets/images/pic08.jpg" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img
								src="${pageContext.request.contextPath}/resources/assets/images/pic09.jpg" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img
								src="${pageContext.request.contextPath}/resources/assets/images/pic10.jpg" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img
								src="${pageContext.request.contextPath}/resources/assets/images/pic11.jpg" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img
								src="${pageContext.request.contextPath}/resources/assets/images/pic12.jpg" alt="" /></a>
						</article>
					</li>
				</ul>
			</section>
